...
%
% what
(2)~Identifying cross-lingual citations across our 1.9\,M document corpus,
% impact
we perform the largest analysis of this kind of citation kind to date, shining light on current trends as well as challenges for scholarly data generation.
% good enough? (↓ could think a little bigger here — i.e. also consider development of extraction models etc.)
These challenges remain a problem for the integration of non-English publications in scholarly data.
% path forward
We see particular potential for improvements 
%
% what
(3)~
% impact
...
Through the above, we achieved comprehensive improvements of data quality, as determined across the five dimensions relevance, accuracy, timeliness, comparability, and completeness.
% TODO: discuss achievements, their limitations, and if the problem now is solved
