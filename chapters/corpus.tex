...
\begin{enumerate}
    ...
    \item A new method for resolving references to consistent global identifiers has been developed. Contrary to the method in~\cite{Faerber2018LREC}, our method has been evaluated and performs very well (see Section~\ref{sec:evaluation-reference-resolution}).
    ...
    \item While the data set in~\cite{Faerber2018LREC} is restricted to computer science, the new data set covers all domains of arXiv (see Section~\ref{sec:statistics} and Figure~\ref{fig:sankey}).
\end{enumerate}
