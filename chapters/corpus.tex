...
\begin{table}[h]
  \caption{Scholarly Data Quality Contributions - \cite{Saier2020}}
  ...
  \begin{small}
    \begin{threeparttable}
      ...
      \end{tabular}
      \begin{tablenotes}
        \item[a] Quality criterion (see Table~\ref{tab:scholdataquali} in Chapter~\ref{chp:foundations})
        \item[b] Result\\\textbf{+} = SOTA/improvement/etc. (see explanation)\\$\circ$ = Not considered
      \end{tablenotes}
    \end{threeparttable}
  \end{small}
\end{table}
  ...
  \begin{small}
    \begin{threeparttable}
      \begin{tabular}{lccccc}
        \toprule
        % TODO: check if some of the =s should be \circs
        \ & \ & \multicolumn{4}{c}{Publication\tnote{a}} \\
        ...
        \midrule
        \multirow{2}{*}{Relevance} & \textbf{C1} & {\large\textbf{+}} & = & {\large\textbf{+}} & = \\
         & \textbf{C2} & $\circ$ & {\large\textbf{+}} & = & {\large\textbf{+}} \\
        \multirow{2}{*}{Accuracy} & \textbf{C3} & {\large\textbf{+}} & = & = & = \\
         & \textbf{C4} & {\large\textbf{+}} & = & = & = \\
        Timeliness & \textbf{C5} & {\large\textbf{+}} & {\large\textbf{+}} & = & = \\
        \multirow{2}{*}{Comparability} & \textbf{C6} & {\large\textbf{+}} & {\large\textbf{+}} & = & = \\
         & \textbf{C7} & $\circ$ & {\large\textbf{+}} & = & {\large\textbf{+}} \\
        \multirow{2}{*}{Completeness} & \textbf{C8} & {\large\textbf{+}} & {\large\textbf{+}} & {\large\textbf{+}} & = \\
         & \textbf{C9} & {\large\textbf{+}} & {\large\textbf{+}} & = & = \\
        \bottomrule
      \end{tabular}
      \begin{tablenotes}
...
% \begin{table}[h]
%   \caption{Scholarly Data Quality Contributions - \cite{Saier2020}/Ch.\ref{chp:corpus}}
%   \label{tab:scholdataquali_corpus}
%   \centering
%   \begin{small}
%     \begin{threeparttable}
%       \begin{tabular}{ccl}  % p{9.7cm}
%         \toprule
%         Crit.\tnote{a} & Res.\tnote{b} & Explanation \\
%         \midrule
%         \textbf{C1} & \ding{73} & Representative coverage in physics, mathematics, CS \\
%         \textbf{C2} & $\circ$ & Primary focus on text content \\
%         \textbf{C3} & {\large\textbf{+}} & $>96$\% accuracy in reference matching \\
%         \textbf{C4} & \textbf{+} & Low noise due to using \LaTeX\ as data source \\
%         \textbf{C5} & \textbf{+} & Publications until end of most recent full year \\
%         \textbf{C6} & \textbf{+} & Provides MAG and arXiv IDs; DOIs in linked MAG \\
%         \textbf{C7} & $\circ$ & Not considered at this stage \\
%         \textbf{C8} & \ding{72} & 42.6\% reference matching success rate \\
%         \textbf{C9} & \textbf{+} & Full-text included \\
%         \bottomrule
%       \end{tabular}
%       \begin{tablenotes}
%         \item[a] Quality criterion (see Table~\ref{tab:scholdataquali} in Chapter~\ref{chp:foundations})
%         \item[b] Result (\ding{72} = new SOTA, \ding{73} = on par with SOTA, \textbf{+} high/suitable (cases in which no direct, quantitative comparison exists), $\circ$ = other)
%       \end{tablenotes}
%     \end{threeparttable}
%   \end{small}
% \end{table}
...
Prior to publishing the data set described in this paper, we already published a data set with annotated arXiv papers' content in the past~\cite{Faerber2018LREC}. In comparison, our new data set is superior to this initial version in the following regards:
\begin{enumerate}
