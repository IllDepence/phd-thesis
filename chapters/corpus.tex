...
\begin{infobox-progress}
      ...
      \begin{tabular}{cp{11.3cm}}
        ...
        Crit. & Explanation \\
        \midrule
        \textbf{C1} & Improved relevance, by providing representative coverage of physics, mathematics, and computer science papers \\
        \textbf{C3} & Improved citation network accuracy, by introducing $>96$\% accurate reference matching method \\
        \textbf{C4} & Improved document representation accuracy, due to low noise through using \LaTeX\ as the data source \\
        \textbf{C5} & Improved coverage, by including publications up until the end of the most recent full year \\
        \textbf{C6} & Improved comparability, by providing MAG and arXiv IDs, as well as DOIs through the linked MAG records \\
        \textbf{C8} & Improved citation network completeness, by achieving 42.6\% reference matching success rate (SOTA) \\
        \textbf{C9} & Improved document representation completeness, by providing full-text \\
        \bottomrule
      \end{tabular}
