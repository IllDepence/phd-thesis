  ...
  \begin{small}
    \begin{threeparttable}
      \begin{tabular}{lll}  % p{9.7cm}
        ...
        \arrayrulecolor{lightgrey}\hline\arrayrulecolor{black}
        \multirow{2}{*}{Timeliness} & \multirow{2}{*}{(both)} & \multirow{2}{*}{\textbf{C5} Coverage of recent publications} \\
        \ & \ & \ \\
        \arrayrulecolor{lightgrey}\hline\arrayrulecolor{black}
...
Based on these considerations, and the resulting quality criteria \textbf{C1\,--\,C9} presented in Table~\ref{tab:scholdataquali} a quantitative view on the goal of the presented work (enabling higher quality scholarly data) and achieved results is possible. In the following section we present the tools to quantitatively assess the information extraction models that enable the improved scholarly data.
