...
\begin{infobox-progress}
      ...
      \begin{tabular}{cp{11.3cm}}
        ...
        Crit. & Explanation \\
        \midrule
        \textbf{C1} & Improved relevance, as detection of cross-lingual citations adds relevant information to the citation network. \\
        \textbf{C6} & Improved comparability, as detection of cross-lingual citations enables more fine granular comparison of nodes and edges is the citation network based on document language. \\
        \bottomrule
      \end{tabular}
