...
\begin{enumerate}
    ...
    \item \textbf{Comparability} quantifies how well the data is comparable to other data, e.g. though the existence of lack of common identifiers.
