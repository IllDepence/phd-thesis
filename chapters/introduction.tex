...
\begin{quote}
\textbf{Structured Representations of Scientific Publications}: data that represents the properties and contents of a piece of scientific literature in a structured way.
\end{quote}

For the sake of brevity we use the term ``scholarly data'' synonymously.\footnote{Note that in other contexts the term ``scholarly data'' can have a broader meaning than just ``structured representations of scientific publications''. For example, it can also include data on research institutions or funding bodies, without necessitating the context of a publication.}

\begin{quote}
\textbf{Scholarly Data}: used synonymously to \textit{Structured Representations of Scientific Publications}.
\end{quote}
