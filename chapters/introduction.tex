...
\textit{Accurate} scholarly data proves difficult to obtain, because, as described earlier, scientific publications are created \textbf{for human consumption} and therefore presuppose visual parsing by a system with relevant background knowledge. The latter point furthermore means there is a challenge of \textbf{information sparsity}. In other words, there are significant challenges in bridging the gap between a human-oriented medium and machine-readable data. Furthermore, the contents of scientific publications pose a challenge due to their \textbf{specialized content}. Because scientific publications address highly specialized topics, they are likely to contain both specialized terminology, as well as specialized notation. Both of these aspects result in further challenges in processing their natural language contents.
