...
This increase in scientific progress, while on first through maybe entirely positive, brings with it a growing challenge for researchers to keep up with the literature. This problem is referred to as ``information overload''~\cite{Landhuis2016}.
However, The digitization of academic publishing not only facilitated an increase in the rate at which research results are being published. It also marks the inception of scholarly data, and thereby enabled search technology and analytics to operate on large collections of digitally archived publications.
In this way, the existence of digital representations of publications also provides, to some degree, a remedy for information overload. Efficient search and recommendation services, for example, can aid researchers in navigating the deluge of publications they're face with.
Similarly, decision processes in academia, such as the evaluation of institutions or researchers, is enabled by scholarly data. In this way, it provides a means for hiring and funding decisions.

However, all of these benefits hinge on the quality of the scholarly data on which the systems and analyses are based. (some examples of what can go wrong because of what) (restate importance of high quality scholarly data) (add segue to current state and potential for improvement) (conclude with laying out motivation for dissertation)
