...
% Adam
% \begin{quote}
% \emph{Thank you for the encouraging words and your welcoming and positive attitude.}
% \end{quote}

% York and all my past and current colleagues at AIFB and FZI
% \begin{quote}
% \emph{Thank you for all the feedback, the banter, and being part of a nice work environment.}
% \end{quote}
...
% \begin{quote}
% \emph{Danke für die Unterstützung.}
% \end{quote}
