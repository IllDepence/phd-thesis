...
The presented approaches to extracting hyperparameter information from scientific text achieve an improvement in RE compared to a state-of-the-art baseline (79\& compared to 39\% in $\text{F}_1$ score). The applicability of the approach on large-scale data is demonstrated through an analysis of hyperparameter reporting patterns in 15,000 unannotated papers. Accordingly, we deem \rtmark{4} successfully achieved.
...
\begin{infobox-progress}
      ...
      \begin{tabular}{lp{10.9cm}}
        ...
        Crit. & Explanation \\
        \midrule
        $\mathbf{Rel_{SDR}}$ & Improved relevance, as extracted hyperparameter information adds a relevant type of content to the structured document representation. \\
        $\mathbf{Coy_{SDR}}$ & Improved comparability of document contents, as extracted hyperparameter information allows for fine-granular comparison based on parameters and their values. \\
        \bottomrule
      \end{tabular}
