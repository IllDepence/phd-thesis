...
\section{HyperPIE Implementation Details}\label{sec:implementation-details}
...
We omitted \texttt{type: dataset/model/method/loss function/regularization technique} field in the examples because we don't have this information in the gold annotation. As a consequence, the model outputs also tend to skip this attribute.
