...
$\mathbf{Coy_{SDR}}$ Our document representation provides a section structure as well as section type information (text, listing, etc.). This enables fine-grained document content comparison, filtering, and combination with external data. % TODO: comparison to other datasets (S2ORC, arXMLiv, PMC-OAS)
