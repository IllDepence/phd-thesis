...
\usepackage[hidelinks,
            pdfauthor={Tarek Saier},
            pdftitle={Data Mining and Information Extraction Methods for Large-Scale High-Quality Representations of Scientific Publications}
           ]{hyperref}
...
\usepackage{enumitem}
\newcommand{\dqmark}[1]{%
    \textbf{{\color{progressblue-box}\faBarChart}\,#1}%
}
...
\usepackage{latexml} % for stylized rendition of "LaTeXML"
\usepackage{listings}
\lstset{
...
\flushleft\small
\begin{align*}
    &\text{Tag der mündlichen Prüfung:} &\text{22. April 2024}\\%XX. Monat XXXX}\\
    &\text{Referent:} &\text{Prof. Dr. Michael Färber}\\
    &\text{Korreferent:} &\text{Prof. Dr. Adam Jatowt}%Prof. Dr. M. M.}
\end{align*}
}
...
% %% -------------------------------- % only needed in submission for review
% %% | Affidavit                    |
% %% --------------------------------
% \cleardoublepage
