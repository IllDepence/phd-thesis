...
\usepackage[citestyle=numeric,style=numeric,backend=biber,defernumbers=true]{biblatex}
\addbibresource{bib/dis.bib}
% Define a custom sorting scheme that sorts by year (earliest first), then name, then title
